...
public class RepayRequestTest {
    ...
    public void given_request_when_happy_path_then_Ok() {
        ...
        //When
        RepayRequest repayRequest = new RepayRequest(1L, new BigDecimal("100.00"));
        Set<ConstraintViolation<RepayRequest>> violations = validator.validate(repayRequest);
    ...
    public void given_request_when_idcustomer_is_zero_then_Ko() {
        ...
        //When
        RepayRequest repayRequest = new RepayRequest(0L, new BigDecimal("100.00"));
        Set<ConstraintViolation<RepayRequest>> violations = validator.validate(repayRequest);
    ...
    public void given_request_when_idcustomer_is_in_range_then_Ok() {
        ...
        //When
        RepayRequest repayRequest = new RepayRequest(Long.MAX_VALUE, new BigDecimal("100.00"));
        Set<ConstraintViolation<RepayRequest>> violations = validator.validate(repayRequest);
    ...
    public void given_request_when_amount_is_positive_then_Ok() {
        ...
        //When
        RepayRequest repayRequest = new RepayRequest(1L, new BigDecimal("1.00"));
        Set<ConstraintViolation<RepayRequest>> violations = validator.validate(repayRequest);
    ...
    public void given_request_when_amount_has_many_decimals_then_Ko() {
        ...
        //When
        RepayRequest repayRequest = new RepayRequest(1L, new BigDecimal("1.000"));
        Set<ConstraintViolation<RepayRequest>> violations = validator.validate(repayRequest);
