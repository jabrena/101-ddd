...
public class WithdrawRequestTest {
    ...
    public void given_request_when_happy_path_then_Ok() {
        ...
        //When
        WithdrawRequest loginRequest = new WithdrawRequest(1L, new BigDecimal("100.00"));
        Set<ConstraintViolation<WithdrawRequest>> violations = validator.validate(loginRequest);
    ...
    public void given_request_when_idcustomer_is_zero_then_Ko() {
        ...
        //When
        WithdrawRequest loginRequest = new WithdrawRequest(0L, new BigDecimal("100.00"));
        Set<ConstraintViolation<WithdrawRequest>> violations = validator.validate(loginRequest);
    ...
    public void given_request_when_idcustomer_is_in_range_then_Ok() {
        ...
        //When
        WithdrawRequest loginRequest = new WithdrawRequest(Long.MAX_VALUE, new BigDecimal("100.00"));
        Set<ConstraintViolation<WithdrawRequest>> violations = validator.validate(loginRequest);
    ...
    public void given_request_when_amount_is_positive_then_Ok() {
        ...
        //When
        WithdrawRequest loginRequest = new WithdrawRequest(1L, new BigDecimal("1.00"));
        Set<ConstraintViolation<WithdrawRequest>> violations = validator.validate(loginRequest);
    ...
    public void given_request_when_amount_has_many_decimals_then_Ko() {
        ...
        //When
        WithdrawRequest loginRequest = new WithdrawRequest(1L, new BigDecimal("1.000"));
        Set<ConstraintViolation<WithdrawRequest>> violations = validator.validate(loginRequest);
