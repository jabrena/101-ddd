 ...
 *
 */
public class ChangingModelExampleTest {

	@Disabled
	@Test
	public void test() throws Exception {

		final String INSURANCE_EXAMPLE_URI2 = "./src/main/cml/Insurance-Example-Model.cml";

		// Setup and loading CML file:
		StandaloneContextMapperAPI contextMapper = ContextMapperStandaloneSetup.getStandaloneAPI();
		CMLResource resource = contextMapper.loadCML(INSURANCE_EXAMPLE_URI2);
